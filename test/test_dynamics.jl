@testset "Dynamics 1" begin
    ...
    @testset "Case 2 adjoints" begin
        ...
        @test isapprox(λ, λfd, rtol=1e-6)
        @test isapprox(μ, μfd, rtol=1e-6)
        ...
        @test isapprox(λfun, λfun_fd, rtol=1e-4)
        @test isapprox(μfun, μfun_fd, rtol=1e-4)
    end
end
